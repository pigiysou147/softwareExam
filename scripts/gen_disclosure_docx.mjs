  ...
  const doc = new Document({
    sections: [{
      ...
      children: [
        ...
        subheading('三、背景技术'),
        para('现有单页/多页应用的路由切换受网络、设备与资源冷启动影响，首屏与二跳耗时大。传统预取多为静态或启发式，无法兼顾会话差异与实时网络波动；缺少带宽/CPU/存储等预算与可解释性。浏览器或CDN的投机预取/预渲染多不感知业务路由语义，不具备个体会话级精细化调度。'),
        subheading('四、发明目的'),
        ...
        subheading('六、附图（专业版）'),
        para('图1 分层架构图'),
        imagePara('/workspace/docs/patent/pro-diagrams/pro-fig1-layered-arch.png', 600),
        para('图2 程序逻辑流程图'),
        imagePara('/workspace/docs/patent/pro-diagrams/pro-fig2-flow.png', 580),
        para('图3 界面交互时序图'),
        imagePara('/workspace/docs/patent/pro-diagrams/pro-fig3-seq.png', 620),
        para('图4 异常与降级处理流程图'),
        imagePara('/workspace/docs/patent/pro-diagrams/pro-fig4-exception.png', 560),
        para('图5 数据结构示意图'),
        imagePara('/workspace/docs/patent/pro-diagrams/pro-fig5-classes.png', 600),
        subheading('七、具体实施方式'),
